 ...
 * 
 */
package com.jimmyc.projectjpa.dao.impl;
...
public class DisqueraDAOImpl implements DisqueraDAO {
	...
	private static final EntityManagerFactory ENTITY_MANAGER_FACTORY = Persistence.createEntityManagerFactory("persistenceJimmyC");
